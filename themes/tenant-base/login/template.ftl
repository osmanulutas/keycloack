...
<div class="${properties.kcLogin!}">
  <div class="${properties.kcLoginContainer!}">
    <#-- ==== tenant-base farki: marka paneli (upstream'de sadece kc-header-wrapper var) ==== -->
    <header id="kc-header" class="pf-v5-c-login__header">
      <div id="kc-brand-panel">
        <div id="kc-header-wrapper"
                class="pf-v5-c-brand">${kcSanitize(msg("loginTitleHtml",(realm.displayNameHtml!'')))?no_esc}</div>
        <div id="kc-brand-copy">
          <#if msg("brandHeadline")?has_content && msg("brandHeadline") != "brandHeadline">
            <p id="kc-brand-headline">${kcSanitize(msg("brandHeadline"))?no_esc}</p>
          </#if>
          <#if msg("brandTagline")?has_content && msg("brandTagline") != "brandTagline">
            <p id="kc-brand-tagline">${kcSanitize(msg("brandTagline"))?no_esc}</p>
          </#if>
        </div>
      </div>
    </header>
    <#-- ==== tenant-base farki sonu ==== -->
